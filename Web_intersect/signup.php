...
if(isset($_POST["u"])){
	...
	include_once("php_includes/root/php_includes/db_conx.php/");
	...
	// END FORM DATA ERROR HANDLING
		...
		$to = "$e";	
		//change the email addres below. 1 - create email on my hosting profile					 
		//if i user gmail, user's will get the email in jun box
...
<!--I can externalize JS script and call it like main.js to include into sign up php-->
<script>
...
function checkusername(){
	...
	if(u != ""){
//anywhere on the website where 3 dots are used, a gif animation can be inserted
...
//first thing, we are gathering up fields into local JS variables that are easier to work with 
function signup(){
	var u = _("username").value;
	var e = _("email").value;
...
//the line below hides singupbutton if conditions above are not met 
...
//code below puts the sign up button back 					
					_("signupbtn").style.display = "block";
				} else {
					window.scrollTo(0,0);
//line below targets the sign up form below 
//the message: "chck your eamil inbox and junk mail" can be customized.
					_("signupform").innerHTML = "OK "+u+", check your email inbox and junk mail box at <u>"+e+"</u> in a moment to complete the sign up process by activating your account. You will not be able to do anything on the site until you successfully activate your account.";
				}
	        }
        }
//the send method shoots variables to php 
...
<!--the sign up form is below-->	
  ...
  <form name="signupform" id="signupform" onsubmit="return false;">
    ...
    <select id="country" onfocus="emptyElement('status')">
    	<!--externalizes the list of countries, modular approach-->
